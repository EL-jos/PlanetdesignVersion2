    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
           ...
           <li class="nav-item">
            ...
            <li class="nav-item">
                <a @class(['nav-link text-white', 'active bg-gradient-primary' => str_contains($route, 'size.')]) href="{{ route('size.index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">receipt_long</i>
                    </div>
                    <span class="nav-link-text ms-1">Taille</span>
                </a>
            </li>
            <li class="nav-item">
                <a @class(['nav-link text-white', 'active bg-gradient-primary' => str_contains($route, 'offer.')]) href="{{ route('offer.index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">receipt_long</i>
                    </div>
