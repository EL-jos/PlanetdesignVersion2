...
<head>
    <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-V8T340HPJP"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-V8T340HPJP');
</script>
    <meta charset="UTF-8">
    ...
    <meta name="description" content="@yield('description', "Explorez un monde de créativité avec PlanetDesign - votre source incontournable pour des gadgets publicitaires uniques et personnalisés. Découvrez une variété de catégories telles que l'écriture, le bureau, la technologie, les textiles et bien plus encore. Donnez vie à votre marque avec des produits conçus pour marquer les esprits. Commandez dès maintenant et faites briller votre entreprise.")">
    <link rel="canonical" href="{{ route('home.page') }}">

    <meta name="robots" content="index, follow">
    <meta property="og:title" content="@yield('og_title', 'Planet Design')">
    <meta property="og:description" content="@yield('og_description',"Explorez un monde de créativité avec PlanetDesign - votre source incontournable pour des gadgets publicitaires uniques et personnalisés. Découvrez une variété de catégories telles que l'écriture, le bureau, la technologie, les textiles et bien plus encore. Donnez vie à votre marque avec des produits conçus pour marquer les esprits. Commandez dès maintenant et faites briller votre entreprise.")">
    <meta property="og:image" content="@yield('og_image', asset('events/logo_fb.png'))">
    <meta property="og:url" content="@yield('og_url', route('home.page'))">
    <meta property="og:type" content="@yield('og_type', "website")">

    <meta property="twitter:title" content="@yield('twitter_title', 'Planet Design')">
    <meta property="twitter:description" content="@yield('twitter_description',"Explorez un monde de créativité avec PlanetDesign - votre source incontournable pour des gadgets publicitaires uniques et personnalisés. Découvrez une variété de catégories telles que l'écriture, le bureau, la technologie, les textiles et bien plus encore. Donnez vie à votre marque avec des produits conçus pour marquer les esprits. Commandez dès maintenant et faites briller votre entreprise.")">
    <meta property="twitter:image" content="@yield('twitter_image', asset('events/logo_fb.png'))">
    <meta property="twitter:url" content="@yield('twitter_url', route('home.page'))">
    <meta name="twitter:creator" content="@planetdesign">
    @section('head')
        <!-- OWL CAROUSEL -->
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.carousel.min.css">
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.theme.default.min.css">
        <link rel="stylesheet" href="{{ asset('css/owl_carousel.css?v=0.0.1') }}" />
        <!-- FONT AWESOME -->
        ...
        <link rel="stylesheet" href="{{ asset('css/responsive.css?v=0.0.1') }}">
        <!-- HTMLX -->
        ...
        <div class="el-content-area">
            <div class="el-grid">
                <a href="{{ route('home.page') }}" class="el-logo">
                    <img src="{{ asset('assets/img/Logo.png') }}" alt="Logo Planet Design">
                </a>
                    ...
                    <div class="accordion-container">
                        @foreach($menuCategories as $category)
                            <div class="accordion-header">
                                <i class="fas fa-angle-down"></i> <a href="{{ route('category.show', ['categorySlug' => $category->slug] ) }}">{{ $category->name }}</a>
                            </div>
    ...
    <section id="el-forces" class="el-center-box">
        <div class="el-content-area">
            ...
            <div class="owl-carousel">
                <div class="el-force">
                    <img src="{{ asset('assets/img/forces/Ellipse-4.png')}}" alt="stock disponible">
                    <h2>stock disponible</h2>
                    <p>
                        PLANET DESIGN importateur  de gadgets publicitaires depuis plus de 20 ans, <br />
                        Nous mettons à la disposition des revendeurs  une gamme très large d’articles publicitaires et promotionnels disponibles en stock pour leur garantir des livraisons express. <br />
                        PLANET DESIGN veille également à choisir des goodies utiles et tendances avec des designs qui suivent le goût local avec une qualité supérieure et prix compétitif  afin de satisfaire les exigences de vos clients.
                    </p>
                </div>
                <div class="el-force">
                    <img src="{{ asset('assets/img/forces/Ellipse-4-copie.png')}}" alt="importations sur mesure">
                    <h2>importations sur mesure</h2>
                    <p>
                        Vous avez des demandes  spéciales <strong>d’objets publicitaires</strong> introuvables sur le marché local ?
                        Nous avons la solution pour vous ! <br />
                        Grâce à nos connexions à l’étranger, nous pouvons travailler des propositions de gadgets personnalisés en forme et style pour offrir des nouveautés à vos clients et donc de les inciter à agir avec une confirmation. <br />
                        Pour une éventuelle commande sur mesure ou sur importation, notre service commercial vous communiquera les dates estimatives de livraison sous des délais raisonnables.
                    </p>
                </div>
                <div class="el-force">
                    <img src="{{ asset('assets/img/forces/Ellipse-4-copie-2.png')}}" alt="gestion de commandes">
                    <h2>gestion de commandes</h2>
                    <p>
                        Pour mieux gérer vos commandes, notre équipe commerciale est réactive et sera toujours à votre écoute pour toutes informations concernant vos demandes de devis, vos commandes et vos livraisons. <br />
                        Nous resterons à votre disposition, pour vous servir dans les plus brefs délais possibles. <br />
                        N’hésitez pas à contacter notre service commercial qui fera le nécessaire pour mieux gérer vos commandes d’objets personnalisables !
                        Par téléphone (+212) 522 450 187 – (+212) 662 015 268
                        Par mail : contact@planetdesign.ma
                    </p>
                </div>
                <div class="el-force">
                    <img src="{{ asset('assets/img/forces/Ellipse-4-copie-3.png')}}" alt="atelier de marquage">
                    <h2>atelier de marquage</h2>
                    <p>
                        Nous disposons depuis plus de 10 ans de notre propre atelier de marquage afin de contrôler et de garantir une qualité premium des objets publicitaires imprimés.
                        Nous avons la certitude que le marquage des logos donne une beauté supplémentaire et un raffinement aux cadeaux publicitaires.
                        C’est la raison pour laquelle nous sommes en perpétuelle recherche des techniques d’impressions qui embellissent nos gadgets publicitaires.
                        De ce fait, nous travaillons toujours à évoluer notre parc de machine et à performer constamment notre qualité de marquage proposée à notre clientèle.
                    </p>
                </div>
                <div class="el-force">
                    <img src="{{ asset('assets/img/forces/Ellipse-4-copie-4.png')}}" alt="livraison express">
                    <h2>livraison express</h2>
                    <p>
                        Soucieux de proposer des délais appréciables de livraison pour vos clients ? Nous allons dans la même optique que vous.
                        Pour mieux vous satisfaire, nous vous garantissons des livraisons expresses dans un délai maximum de 24h ouvrables pour les articles publicitaires disponibles en stock sans impression.
                        Concernant nos goodies avec impression, nos délais sont courts et nous sommes assez réactifs et diligents.
                        Les délais de livraison vous seront communiqués lors de votre confirmation de BAT car cela dépendra des productions en cours et le volume de votre commande.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="el-content-area">
            <article>
                <div class="el-block">
                    <h2>menu</h2>
                    <ul>
                        <li><a href="{{ route('category.show', ['categorySlug' => 'ecriture']) }}">ecriture</a></li>
                        <li><a href="{{ route('category.show', ['categorySlug' => 'bureau-event']) }}">bureau & event</a></li>
                        <li><a href="{{ route('category.show', ['categorySlug' => 'loisirs']) }}">loisirs & bien être</a></li>
                        <li><a href="{{ route('category.show', ['categorySlug' => 'technologie']) }}">technologie</a></li>
    ...
    @section('scripts')
        ...
        <script>
            $(document).ready(function(){
                ...
                $("#el-offres .owl-carousel").owlCarousel({
                    items: 1,
                    loop: true,
                    nav: false,
                    dots: true,
                ...
                $("#el-slider .owl-carousel").owlCarousel({
                    items: 1,
                    loop: true,
                    nav: true,
                    dots: false,
