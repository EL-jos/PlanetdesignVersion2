...
@section('main-content')
    <div class="card card-warning">
        ...
        <div class="card-body">
            <form action="{{ $material->exists ? route('material.update', $material) : route('material.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control is-valid" name="name" id="name" placeholder="Nom ..." value="{{ $material->exists ? $material->name : old('name') }}">
                </div>
