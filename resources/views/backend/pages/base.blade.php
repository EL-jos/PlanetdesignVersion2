...
<head>
    ...
    <title>VertigoDigital | Dashboard</title>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ route("size.index") }}" @class(["nav-link", "active" => str_contains($route, 'size.')])>
                            <i class="nav-icon fas fa-th"></i>
                            <p>
                                Dimensions
                            </p>
                    ...
                    <li class="nav-item">
                        <a href="{{ route("availability.index") }}" @class(["nav-link", "active" => str_contains($route, 'availability.')])>
                            <i class="nav-icon fas fa-th"></i>
                            <p>
                                Disponibilité
                            </p>
                    ...
                    <li class="nav-item">
                        <a href="{{ route("subcategory.index") }}" @class(["nav-link", "active" => str_contains($route, 'subcategory.')])>
                            <i class="nav-icon fas fa-th"></i>
                            <p>
                                Sous-Catégories
                            </p>
                    ...
                    <li class="nav-item">
                        <a href="{{ route("offer.index") }}" @class(["nav-link", "active" => str_contains($route, 'offer.')])>
                            <i class="nav-icon fas fa-th"></i>
                            <p>
                                Offres
                            </p>
