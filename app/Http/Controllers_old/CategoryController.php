...
class CategoryController extends Controller
{
    ...
    public function show(Category $category)
    {
        ...
        //$articles = Article::whereIn('subcategory_id', $subcategoryIds)->paginate(33); // Par exemple, 10 articles par page
    ...
    public function remove(int $id){
        ...
        $category = Category::withTrashed()->find($id);
        $this->deleteImage($category->image->path);
...
//    }
    ...
    public function updateOrder(Request $request){
        ...
        foreach ($itemsIds as $index => $itemId) {
            $category = Category::where('id', $itemId)->first();
            if ($category) {
                $category->update(['priority' => $index + 1]);
            }
        }
